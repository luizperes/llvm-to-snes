//===-- SNESMachineFuctionInfo.h - SNES machine function info -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares SNES-specific per-machine-function information.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SNES_MACHINE_FUNCTION_INFO_H
#define LLVM_SNES_MACHINE_FUNCTION_INFO_H

#include "llvm/CodeGen/MachineFunction.h"

namespace llvm {

/// Contains SNES-specific information for each MachineFunction.
...
#endif // LLVM_SNES_MACHINE_FUNCTION_INFO_H
