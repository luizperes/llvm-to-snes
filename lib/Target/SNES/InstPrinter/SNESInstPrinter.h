//===- SNESInstPrinter.h - Convert SNES MCInst to assembly syntax -*- C++ -*-===//
//
...
#ifndef LLVM_SNES_INST_PRINTER_H
#define LLVM_SNES_INST_PRINTER_H
...
/// Prints SNES instructions to a textual stream.
...
#endif // LLVM_SNES_INST_PRINTER_H
