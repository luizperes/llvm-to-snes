...
#ifndef LLVM_SNES_FIXUP_KINDS_H
#define LLVM_SNES_FIXUP_KINDS_H
...
///       MCFixupKindInfo Infos[SNES::NumTargetFixupKinds]
///       in `SNESAsmBackend.cpp`.
enum Fixups {
  /// A 32-bit SNES fixup.
  ...
  ///       The nonmenclature is that SNES branch targets are
...
/// All branch targets in SNES are rightshifted by 1 to take advantage
...
} // end of namespace llvm::SNES

#endif // LLVM_SNES_FIXUP_KINDS_H
