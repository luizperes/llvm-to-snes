//===-- SNESInstrumentFunctions.cpp - Insert instrumentation for testing ---===//
//
...
#define SNES_INSTRUMENT_FUNCTIONS_NAME "SNES function instrumentation pass"
...
#define SYMBOL_PREFIX "snes_instrumentation"
...
class SNESInstrumentFunctions : public FunctionPass {
public:
  static char ID;

  SNESInstrumentFunctions() : FunctionPass(ID) {
    initializeSNESInstrumentFunctionsPass(*PassRegistry::getPassRegistry());
  }

  bool runOnFunction(Function &F) override;

  StringRef getPassName() const override { return SNES_INSTRUMENT_FUNCTIONS_NAME; }
};

char SNESInstrumentFunctions::ID = 0;
...
bool SNESInstrumentFunctions::runOnFunction(Function &F) {
...
INITIALIZE_PASS(SNESInstrumentFunctions, "snes-instrument-functions",
                SNES_INSTRUMENT_FUNCTIONS_NAME, false, false)

namespace llvm {

FunctionPass *createSNESInstrumentFunctionsPass() { return new SNESInstrumentFunctions(); }
